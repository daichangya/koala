 ...
 * @version: v1.0
 * @description: 修改一下 SortedMap 规则 subMap 支持 [start,end]
 * @date:19-12-17
 */
 ...
 */
public class BpTreeDb<K, V> extends AbstractMap<K, V> implements SortedMap<K, V> {
     ...
     */
    public BpTreeDb(int order, int leafOrder)
     ...
     * @throws IllegalArgumentException thrown if order < 3 or leafOrder < 1.
     */
    public BpTreeDb(Comparator c, int order, int leafOrder)
            throws IllegalArgumentException {
        this.comp = c;
        this.order = order;
    ...
    public Comparator<K> comparator() {
        if (comp instanceof BpTreeDb.DefaultComparator)
            return null;
        else
            return comp;
    }
    ...
    public boolean containsKey(Object key) {
        Node cur = root;
        while (cur instanceof BpTreeDb.GuideNode) {
    ...
    public V remove(Object key) {
        ...
        if (root instanceof BpTreeDb.GuideNode && root.keys.size() == 1)
    ...
    private class GuideNode extends Node {
        ...
        private int findGuideIndex(Object key) {
            return BpTreeDb.this.findGuideIndex(this, key);
        }
    ...
    private class LeafNode extends Node {
        ...
        private int findLeafIndex(Object key) {
            return BpTreeDb.this.findLeafIndex(this, key);
        }
    ...
    private class SubMap extends AbstractMap<K, V> implements SortedMap<K, V> {
         ...
         */
        public boolean containsKey(Object key) {
            return checkKey(key) && BpTreeDb.this.containsKey(key);
        }
        ...
        public V put(K key, V value) {
            if (checkKey(key))
                return BpTreeDb.this.put(key, value);
            else
        ...
        public V remove(Object key) {
            if (checkKey(key))
                return BpTreeDb.this.remove(key);
            else
                return null;
        }
        ...
        public Comparator comparator() {
            return BpTreeDb.this.comparator();
        }
        ...
        public SortedMap<K, V> subMap(K arg0, K arg1) {
            ...
            // Return a new SubMap.
            return BpTreeDb.this.subMap(newLow, newHigh);
        }
        ...
        private class EntrySet extends AbstractSet<Entry<K, V>> {
            ...
            public boolean contains(Object entry) {
                if (entry instanceof Entry) {
                    ...
                    if (BpTreeDb.SubMap.this.containsKey(e.getKey())) {
                        V value = BpTreeDb.SubMap.this.get(e.getKey());
            ...
            public boolean remove(Object entry) {
                if (contains(entry)) {
                    BpTreeDb.SubMap.this.remove(((Entry<K, V>) entry).getKey());
                    return true;
                } else {
                    return false;
                }
            ...
            private class EntrySetIterator implements Iterator<Entry<K, V>> {
                ...
                public EntrySetIterator() {
                    modCount = BpTreeDb.this.modCount;
                    curNode = BpTreeDb.this.firstLeaf;
                ...
                public Entry<K, V> next() {
                    ...
                    if (modCount != BpTreeDb.this.modCount)
                    ...
                    // Get entry.
                    lastEntry = new BPTEntry(curNode.keys.get(curIndex), BpTreeDb.this);
                ...
                public void remove() {
                    ...
                    BpTreeDb.SubMap.this.remove(lastEntry.getKey());
                    if (curKey != null)
